...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(local); Database=MovieDB;Trusted_Connection=True;Encrypt=false");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Auditorium>(entity =>
        {
            entity.HasKey(e => e.AuditoriumId).HasName("PK__Auditori__B78BBE886815BCFD");
            ...
            entity.HasOne(d => d.AuditoriumTypeNavigation).WithMany(p => p.Auditoria)
                ...
                .HasConstraintName("FK__Auditoriu__audit__440B1D61");
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Bookings__5DE3A5B14167AD36");
            ...
            entity.HasOne(d => d.Showtime).WithMany(p => p.Bookings)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Bookings__showti__59FA5E80");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__Comments__E79576873EAD368B");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Comments)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__Comments__user_i__6754599E");
        });

        modelBuilder.Entity<Movie>(entity =>
        {
            entity.HasKey(e => e.MovieId).HasName("PK__Movies__83CDF749B5AE9392");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__ED1FC9EA9D65A54D");

            entity.HasIndex(e => e.TransactionId, "UQ__Payments__85C600AE7B880EC3").IsUnique();
        ...
        {
            entity.HasKey(e => e.Type).HasName("PK__PriceByT__9962CFB8A3EC5534");
        ...
        {
            entity.HasKey(e => e.SeatId).HasName("PK__Seats__906DED9CABBD67D5");
            ...
            entity.HasOne(d => d.SeatTypeNavigation).WithMany(p => p.Seats)
                ...
                .HasConstraintName("FK__Seats__seat_type__49C3F6B7");
        });

        modelBuilder.Entity<SeatBooking>(entity =>
        {
            entity.HasKey(e => e.SeatBookingId).HasName("PK__Seat_Boo__714E8C0F94676E06");
            ...
            entity.HasOne(d => d.Booking).WithMany(p => p.SeatBookings)
                .HasForeignKey(d => d.BookingId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Seat_Book__booki__5CD6CB2B");

            entity.HasOne(d => d.Seat).WithMany(p => p.SeatBookings)
                .HasForeignKey(d => d.SeatId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Seat_Book__seat___5DCAEF64");
        });

        modelBuilder.Entity<Showtime>(entity =>
        {
            entity.HasKey(e => e.ShowtimeId).HasName("PK__Showtime__A406B518DEA07511");
            ...
            entity.HasOne(d => d.Auditorium).WithMany(p => p.Showtimes)
                .HasForeignKey(d => d.AuditoriumId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Showtimes__audit__5535A963");
        ...
        {
            entity.HasKey(e => e.TheaterId).HasName("PK__Theaters__B53C958F7CE46DCC");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__EE50E8ED4701D450");

            entity.HasIndex(e => e.PhoneNumber, "UQ__Users__A1936A6BC183AE39").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__AB6E616421763641").IsUnique();
